...
- **Le guide d’urgence affiche le numéro des secours de votre pays.** Il affichait auparavant « 911 / 112 » pour tout le monde, ce qui est faux en Thaïlande (ligne médicale 1669), au Royaume-Uni (999), en Australie (000), au Japon (119) et ailleurs. 172 fuseaux horaires renvoient vers 19 numéros, tout fuseau inconnu retombe sur « 112 / 911 », et le guide vous demande toujours de vérifier le numéro de votre pays et de l’afficher au mur du studio plutôt que de faire confiance à une déduction.
