...
- **De noodgids toont het alarmnummer van jouw land.** Er stond eerder voor iedereen "911 / 112", wat verkeerd is in Thailand (medische lijn 1669), het Verenigd Koninkrijk (999), Australië (000), Japan (119) en meer. 172 tijdzones verwijzen naar 19 nummers, een niet-gekoppelde zone valt terug op "112 / 911", en de gids vraagt je altijd het nummer van je eigen land te controleren en het in de studio aan de muur te hangen in plaats van op een gok te vertrouwen.
